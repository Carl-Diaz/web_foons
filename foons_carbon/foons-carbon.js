document.addEventListener('DOMContentLoaded', () => {
  ...
  botonReserva?.addEventListener('click', () => {
    ...
    const mensaje = `Hola Foons Al Carbón, quiero hacer una reserva.%0A%0ANombre: ${encodeURIComponent(nombre)}%0ATeléfono: ${encodeURIComponent(telefono)}%0AHora: ${encodeURIComponent(horaReserva.formato)}%0ACantidad de personas: ${encodeURIComponent(personas)}`;
    window.open(`https://wa.me/573225234154?text=${mensaje}`, '_blank', 'noopener');
